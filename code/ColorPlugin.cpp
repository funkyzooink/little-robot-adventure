...
void ColorPlugin::initLayerBackground(cocos2d::TMXTiledMap* tiledMap, int worldID, cocos2d::Node* cameraFollowNode)
{
    ...
    if (grp)
    {
        ...
        for (auto& object : objects)
        {
            ...
            cocos2d::Color4F bgColor =
                colorHelper(Utility::colorConverterFloat(GAMECONFIG.getWorldColors(worldID, 0)),
                            Utility::colorConverterFloat(GAMECONFIG.getWorldColors(worldID, 1)), div);
    ...
    if (grp)
    {
        ...
        for (auto& object : objects)
        {
            ...
            if (name == "color")
            {
                ...
                cocos2d::Color4F fgColor =
                    colorHelper(Utility::colorConverterFloat(GAMECONFIG.getWorldColors(worldID, 1)),
                ...
                switch (worldID)
                {
                    case 0:
                    {
                        if (name == "diamond" || name == "treeshape5")  // mNWorldNr<4)
                        {
                            ...
                            background1->setLocalZOrder(Constants::LocalZOrderEnum::BACKGROUND_Z_ORDER);  // TODO was -
                                                                                                          // 4
                    ...
                    case 1:
                        ...
                        else
                        {
                            ...
                            background1->setLocalZOrder(Constants::LocalZOrderEnum::BACKGROUND_Z_ORDER);  // TODO was -
                                                                                                          // 4
                            background1->setAnchorPoint(cocos2d::Vec2::ANCHOR_BOTTOM_LEFT);
                            if (name == "tree0" || name == "tree1" || name == "tree2" || name == "tree3" ||
                                name == "tree4" || name == "rock0" || name == "rock1" || name == "rock2" ||
                                name == "rock3" || name == "rockred0" || name == "rockred1" || name == "rockred2" ||
                                name == "rockred3")
                            {
                                background1->setFlippedX(Utility::randomValueBetween(0, 1));
                                background1->setPosition(initialPosition.x,
                                                         initialPosition.y - CONSTANTS.getOffset() * 0.1);
                            }
                            else
                            {
                                //                    if(name=="tree" || name=="tree2")
                    ...
                    default:
                        ...
                        else if (name == "plant0" || name == "plant1" || name == "plant2" || name == "plant3" ||
                                 name == "plant4" || name == "plant5" || name == "plant6" || name == "mushroom0" ||
                                 name == "mushroom1" || name == "mushroom2" || name == "mushroom3")
                        {
                            //                    background1->setColor(cocos2d::Color3B(192,
                            //                    104, 31));
                            background1->setFlippedX(Utility::randomValueBetween(0, 1));
                        }
                        else if (name == "tree0" || name == "tree1" || name == "tree2" || name == "tree3" ||
                                 name == "tree4" || name == "rock0" || name == "rock1" || name == "rock2" ||
                                 name == "rock3" || name == "rockred0" || name == "rockred1" || name == "rockred2" ||
                                 name == "rockred3")
                        {
                                              ...
                                              float tHeight, bool gradient)
{
    ...
    if (gradient)
    {
        ...
        cocos2d::BlendFunc blend2 = { cocos2d::backend::BlendFactor::DST_COLOR, cocos2d::backend::BlendFactor::ZERO };
